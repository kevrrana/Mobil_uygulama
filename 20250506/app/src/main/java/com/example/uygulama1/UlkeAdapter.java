...
public class UlkeAdapter extends BaseAdapter {
    ...
    @Override
    public View getView(int i, View view, ViewGroup parent) { //liste görünümü olusturur.
        ImageView ivSatirBayrak;
        TextView tvSatirAd,tvSatirBaskent,tvSatirNufus;

        Ulke ulke=ulkeler.get(i);//sıradaki nesne ülkesi elde edilir

        if(view ==null){
            view =view.inflate(context,R.layout.satir,null);
        }

        //xml'de tanımlı birleşenler ayarlanır.
        ...
        //her birleşene ülke nesnesinden alınan deger alınır.
